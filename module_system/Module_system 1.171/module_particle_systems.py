...
particle_systems = [
	...
	# #######################################################################
	 ...
	 ("sun_blue_01", psf_billboard_3d|psf_always_emit|psf_randomize_rotation, "star_blue_01",
     1, 100, 0, 0, 0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 1), (1, 1),        #alpha keys
     (0, 1), (1, 1),      #red keys
     (0, 1), (1, 1),       #green keys
     (0, 1), (1, 1),      #blue keys
     (0, 25), (1, 25),   #scale keys
     (0, 0, 0),      #emit box size
     (0, 0, 0),               #emit velocity
     0.0,                       #emit dir randomness
     100,                       #rotation speed
