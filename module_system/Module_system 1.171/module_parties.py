...
#			Definitely not hardcoded, but a good reference.
# #######################################################################
pt_none = 0
# #######################################################################
#		Parties
...
parties = [
    ...
    ("main_party", "Main Party", icon_player|pf_limit_members|pf_no_label|pf_is_static, 0, pt_none, fac_commoners, 0, ai_bhvr_hold, 0, (0, 0), [(trp_player, 1, 0)]),
