...
# Updated to Include WSE2 Flags, Up-to-date as of 1.1.0.3
...
itp_shield_no_parry		= 0x0000000000004000 	# left handed item without shield functionality	(WSE2)
itp_offset_mortschlag	= 0x1000000000000000	# offsets melee weapon to mortschlag grip (WSE2)
itp_covers_hands		= 0x1000000000000000 	# remove hands mesh (works on body armor items) (WSE2)
itp_crush_through_any_direction = 0x2000000000000000 #crush through works with any attack direction (WSE2)
itp_offset_flip			= 0x4000000000000000 	# flips melee weapon model 180 degrees on y-axis (WSE2)
