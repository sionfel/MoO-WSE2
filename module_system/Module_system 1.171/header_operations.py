...
# [ Z27 ] WSE2 Operations. (Current as of 1.0.8.0)
################################################################################
...
################################################################################
  ...
  # Recently updated to include all engine changes
...
try_for_agents    		= 	12	# (try_for_agents, <destination>, [<position_no>], [<radius_fixed_point>]),
                                # Runs a cycle, iterating all agents on the scene. With optional parameters it only checks for agents within the radius around the position
...
is_camera_in_first_person       	  =  61   # (is_camera_in_first_person),
											  # Fails if the game camera is in third person.
...
allow_ironman						  =  988  # (allow_ironman, <value>), # 1 = allow, 0 = disallow
											  # Testing: Maybe quit without save? Check VC
...
lhs_operations += [ try_for_agents, agent_get_ammo_for_slot, agent_get_item_cur_ammo, agent_get_damage_modifier, agent_get_accuracy_modifier, agent_get_speed_modifier, agent_get_reload_speed_modifier, agent_get_use_speed_modifier, store_trigger_param, store_random, store_random_in_range, face_keys_get_morph_key, val_shr, store_shr, val_lshr, store_lshr, val_shl, store_shl, val_xor, store_xor, val_not, store_not, player_get_wse2_version, player_get_party_id, register_get, store_wse_version, store_current_trigger, store_num_return_values, store_return_value, mtrand, get_time, timer_get_elapsed_time, get_main_party, store_application_time, get_campaign_time, game_key_get_key, dict_create, dict_get_size, dict_get_int, agent_get_item_modifier, agent_get_item_slot_modifier, agent_get_animation_progress, agent_get_dna, agent_get_ground_scene_prop, agent_get_item_slot_hit_points, agent_get_wielded_item_slot_no, agent_get_scale, agent_get_item_slot_flags, agent_get_personal_animation, agent_get_ranged_damage_modifier, agent_body_meta_mesh_get_current_deform_progress, agent_body_meta_mesh_get_current_deform_frame, agent_get_horse_rotation_velocity, agent_get_current_vertical_speed, agent_get_current_ai_mesh_face_group, agent_get_time_speed_multiplier, agent_get_action_speed_modifier, multiplayer_get_cur_profile, multiplayer_get_num_profiles, multiplayer_cur_message_get_int, multiplayer_cur_profile_get_skin, server_map_rotation_get_count, server_map_rotation_get_index, server_map_rotation_get_map, server_get_horse_friendly_fire, server_get_show_crosshair, get_server_option_at_connect, store_cur_mission_template_no, get_spectated_agent_no, get_water_level, prop_instance_get_sound_progress, cast_ray_agents, troop_get_skill_points, troop_get_attribute_points, troop_get_proficiency_points, party_stack_get_experience, party_stack_get_num_upgradeable, party_get_banner_icon, party_get_extra_icon, party_get_player_id, position_get_vector_to_position, position_get_length, get_dot_product_of_positions, str_length, str_index_of, str_last_index_of, str_get_char, str_to_num, str_compare, str_split, str_regex_get_matches, options_get_verbose_casualties, options_get_cheat_mode, options_get_realistic_headshots, fst, edit_mode_get_num_selected_prop_instances, edit_mode_get_selected_prop_instance, edit_mode_get_highlighted_prop_instance, menu_create_new, overlay_get_val, overlay_get_scroll_pos, array_create, array_copy, array_load_file, array_get_val, array_pop, array_get_dim_size, array_get_dim_count, array_get_type_id, lua_get_top, lua_to_int, lua_get_type, ]
can_fail_operations += [ key_is_down, key_clicked, game_key_is_down, game_key_clicked, is_vanilla_warband, item_slot_gt, party_template_slot_gt, troop_slot_gt, faction_slot_gt, quest_slot_gt, scene_slot_gt, party_slot_gt, player_slot_gt, team_slot_gt, agent_slot_gt, scene_prop_slot_gt, order_flag_is_active, is_party_skill, profiler_is_recording, key_released, game_key_released, dict_is_empty, dict_has_key, multiplayer_is_campaign, missile_is_valid, cast_ray_agents, troop_has_flag, party_has_flag, party_is_non_player, str_equals, str_contains, str_starts_with, str_ends_with, str_is_alpha, str_is_digit, str_is_whitespace, str_is_integer, str_regex_match, str_regex_search, feq, fgt, flt, fge, fle, edit_mode_in_edit_objects_mode, presentation_activate, array_eq, array_neq, array_gt, array_ge, array_lt, array_le, lua_call, lua_triggerCallback, ]